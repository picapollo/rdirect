...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:fb="http://www.facebook.com/2008/fbml">
    ...
    <!--[if (!IE)|(gte IE 8)]><!-->
<link href="http://s3.muscache.com/1312792885/assets/common-datauri.css" media="screen" rel="stylesheet" type="text/css" />
<!--<![endif]-->
<!--[if lte IE 7]>
...
<![endif]-->
    ...
    <link href="http://s2.muscache.com/1312750804/stylesheets/dashboard.css" media="screen" rel="stylesheet" type="text/css" />


		<script src="http://s1.muscache.com/1312793591/assets/common.js" type="text/javascript"></script>
...
<div class="narrow_page_bg rounded_most">
    <div id="page5" class="rounded_more drop_shadow_standard">
        <div class="narrow_page_section rounded_more checkout_error_message">
            <h2 class="rounded_more">Success! Your message has been sent.</h2>
        </div>
    

<div class="narrow_page_section rounded_more">
    <div id="send_message">
...
Get a faster response!
      ...
      <div id="user_area" class="rounded_bottom">
<div id="facebook_profile_form_stuff">
  <div style="margin:10px;">
    <span style="font-size:18px;"> You can import your photo and profile info from Facebook. </span><br/><br/>
    <fb:login-button size="xlarge" width="200" max-rows="1" id="fb_login2" onlogin="jQuery('#fb_login2').hide();jQuery('#login_spinner2').show();jQuery.get('/users/populate_from_facebook',function() {jQuery('#update_user_form').submit(); });" perms="email,user_birthday,user_likes,user_education_history,user_hometown,user_interests,user_activities,user_location"></fb:login-button><span id="login_spinner2" style="padding-top:2px;padding-left:5px;display:none;"><img src="/images/spinner.gif"/></span>
<br/>
    <div style="margin-left:0px;margin-top:20px;cursor:pointer;text-decoration:underline;" id="facebook_form_toggle">Don't have a Facebook account?</div>
    <script type="text/javascript">
        jQuery(document).ready(function(){
            jQuery('#facebook_form_toggle').click(function(){
                jQuery('#non_facebook_form_stuff').show();
            });
        });
    </script>
  </div>
     </div>
<div id="non_facebook_form_stuff" style="display:none;">
            <div id="user_left">
                <div id="ajax_upload_container" style="display:none; top:-4px; left:135px;">
                    <h3>Upload a Photo</h3>
                    <p class="about_photos">
                            Uploading a photo of yourself is a great way to earn trust on Airbnb.
                    </p>
                    ...
                    <form target="upload_frame" action="/users/ajax_image_upload" id="ajax_upload_form" name="ajax_upload_form" method="post" enctype="multipart/form-data">
                        ...
                        <input id="upload_image_submit_button" type="submit" value="Upload Photo" onclick="$('ajax_upload_form').submit(); wait_for_upload(); return false;" />
                    </form>
                ...
                <div id="user_pic" onclick="$('ajax_upload_container').toggle();" style="margin:0 0 10px 0;">
                    ...
                    <img alt="Hojoon L" height="209" src="http://s2.muscache.com/1308680853/images/user_pic-225x225.png" title="Hojoon L" width="209" />
                </div>

                <p style="text-align:center;">
                    <a href="javascript:void(0);" onclick="$('ajax_upload_container').toggle();" style="font-size:16px;"><img alt="Page5_blue_up_arrow" src="http://s1.muscache.com/1300304855/images/../images/payment/v3/page5_blue_up_arrow.png" /> Upload a Photo</a>
                </p>

            </div><!-- #user_left -->

            <div id="user_right">
<form action="/reservation/requested?code=5ETBAF" id="update_user_form" method="post" name="update_user_form" onsubmit="if(submit_user_form()){return true;}">
                    <div id="user_fields" class="rounded_bottom_right">
                        <label class="inner_text" for="">School</label>
                        <br class="remove_if_js" />
                        <input id="user_profile_info_university" name="user_profile_info[university]" size="30" style="margin-bottom:10px;" type="text" value="" />
                        <br class="remove_if_js" />

                        <label class="inner_text" for="">Where you live</label>
                        <br class="remove_if_js" />
                        <input id="user_profile_info_current_city" name="user_profile_info[current_city]" size="30" type="text" value="코스타리카" />
                        <br />

                        <br />
                        <label for="" style="font-size:15px; padding:4px 8px; color:#A2A29C;">About you...</label>
                        <br />
                        <textarea cols="40" id="user_profile_info_about" name="user_profile_info[about]" rows="20">해치지않아요</textarea>

                    </div>

                    <input type="hidden" name="page5_action" value="update_user_profile" />
</form>            </div>
  </div>
        </div>
    </div>
...
<div class="send_message_actions">
  <a href="/reservation/requested?code=5ETBAF&amp;previous_step=update_user_profile">Skip</a>

    <input name="submit" type='submit' id="submit_user_form_button" class='v3_button' value="Save" onclick="if(submit_user_form()){document.update_user_form.submit();}" />
</div>
...
<script type="text/javascript">
    function submit_user_form(){
        $('submit_user_form_button').disabled = 'disabled';
        $('submit_user_form_button').style.cursor = 'progress';
...
if ((navigator.userAgent.indexOf('iPhone') == -1) && (navigator.userAgent.indexOf('iPod') == -1) && (navigator.userAgent.indexOf('iPad') == -1)) {
    jQuery(window).load(function() {
        LazyLoad.js([
			"http://s0.muscache.com/1300304855/javascripts/jquery.autocomplete_custom.pack.js",
			"http://s0.muscache.com/1310614506/javascripts/en_autocomplete_data.js"],
			function() {
            	jQuery("#user_profile_info_current_city").autocomplete(autocomplete_terms, {
	                minChars: 1, width: 319, max:20, matchContains: false, autoFill: true,
	...
	<script type="text/javascript" charset="utf-8">NREUMQ.push(["nrf2","beacon-1.newrelic.com","fc09a36731",2237,"dlwMQktaWAgBEB1AVkZWEEBYQV0LCk1AV0JAVhFCXFE=",0,74])</script></body>
</html>
