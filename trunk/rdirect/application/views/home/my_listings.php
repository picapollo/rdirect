...
<![endif]-->
    ...
    <link href="http://s2.muscache.com/1312750804/stylesheets/dashboard.css" media="screen" rel="stylesheet" type="text/css" />
      ...
      <link href="http://s0.muscache.com/1300304856/stylesheets/korean_fonts.css" media="screen" rel="stylesheet" type="text/css" />
        ...
        <script src="http://s2.muscache.com/1312795995/assets/common.js" type="text/javascript"></script>
...
<li id="star-indicator"><a href="/search?starred=true" class="notification_icon starred" title="View your starred items">                                <span style="width: 1px; margin-right: -5px;">&nbsp;</span>
            ...
            <li style="border-right:1px solid #DDD;"><a href="/info/how_it_works">에어비앤비 이용방법</a></li>
              ...
              <div id="notice">예약이 승인 되었습니다. 여행객에게 보내신 메세지가 전달되었습니다.</div>
...
<ul id="nav">
    <li><a href="/dashboard">마이 대쉬보드</a></li>
    <li ><a href="/inbox">메시지수신함</a></li>
    <li class="active" ><a href="/rooms">호스팅하기</a></li>
    <li ><a href="/trips">여행하기</a></li>
    <li ><a href="/account">계정관리하기</a></li>
    ...
    <ul class="subnav">
    <li ><a href="/rooms">객실정보관리</a></li>
    <li class="active"><a href="/my_listings">예약관리</a></li>
    <li><a href="/hosting/standbys">스탠바이 리스트</a></li>
    <li><a href="/hosting/policies">환불정책</a></li>
    <li><a href="/hosting/requirements">예약 조건</a></li>
</ul>


    
    <div id="my_listings" class="box">
                <div class="top">&nbsp;</div>
                    <div class="middle">

                        <div class="print_button">
                            <img alt="Icon_printer" src="http://s2.muscache.com/1300304855/images/../images/icon_printer.gif" /> <a href="/home/my_listings?all=0&amp;print=1" target="_blank">이 페이지를 출력하기</a>
                        </div>

                        <ul class="my_reservations">
                            <li class="headings">
                                <p class="status">상태</p>
                                <p class="location">날짜와 위치</p>
                                <p class="guest">여행객</p>
                                <p class="details">내용</p>
                            </li>

                            <li>
                                <p class="status">
                                    <span class="reservation_accepted rounded_less">
                                        수락되었습니다.
                                    </span>
                                </p>
                                <p class="location">
                                ...
                                <p class="guest"> 
                                    <span class="guest_photo"><img alt="Hojoon L" height="50" src="http://s3.muscache.com/1308680853/images/user_pic-50x50.png" title="Hojoon L" width="50" /></span>
                                    <span class="guest_details">
                                            <a href="/users/show/778613">Hojoon Lim</a>
                                            <br />
                                            <a href="mailto:bdirect@naver.com">bdirect@naver.com</a>
                                            <br />
                                            <span class="phone_number_to_format">(unknown phone number)</span>
                                            <br />
                                        <a href="/messaging/qt_with/778613" class="action_button_link">메세지 보내기</a>
                                    </span>
                                </p>
                                <p class="details">
                                    $20 합계
                                    <br />
                                        <a href="/reservation/print_confirmation?code=5ETBAF" target="_blank">확인증을 출력하기</a>
                                        <br />
                                        <a href="/reservation_alterations/new?code=5ETBAF">예약 변경하기</a>
                                        <br />
                                        <a href="/reservation/host_cancel?code=5ETBAF">예약 취소</a>
                                        <br />
                                    <a href="/messaging/qt_with/778613">메세지함</a>
                                </p>
                        ...
                        <div class="show_all_reservations">
                            <a href="/home/my_listings?all=1">모든 예약 내용 보기</a>
                        </div>
    ...
    <script type="text/javascript" charset="utf-8">NREUMQ.push(["nrf2","beacon-1.newrelic.com","fc09a36731",2237,"dlwMQktaWAgBEB1aXFhWTVtAalgNFxZbXFRG",0,117])</script></body>
</html>
