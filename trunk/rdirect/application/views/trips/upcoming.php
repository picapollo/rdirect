...
<![endif]-->
    <link href="http://s2.muscache.com/1312750804/stylesheets/dashboard.css" media="screen" rel="stylesheet" type="text/css" />
		...
		<script src="http://s2.muscache.com/1312794582/assets/common.js" type="text/javascript"></script>
...
<ul id="nav">
    ...
    <ul class="subnav">
    <li><a href="/trips/current">Current Trips</a></li>
    <li class="active"><a href="/trips/upcoming">Upcoming Trips</a></li>
    ...
    <div id="trips">
            ...
            <div class="box">
                ...
                <div class="middle">
                    <ul class="previous_trips">
                        <li class="headings previous_trips_item clearfix">
	...
	<li class="previous_trips_item clearfix">
	    <p class="status"><span class="reservation_pending rounded_less">Pending</span></p>
	    <p class="location">
	        <a href="http://www.airbnb.com/rooms/193448">큰개키우는집</a> Seoul
	    </p>
	    <p class="host"><a href="/users/show/738217">Choimyun 김</a></p>
	    <p class="dates">Aug 9 - 11, 2011</p>
	      
	      <ul class="button-list">
	        <li class="button-list-item"><a href="/messaging/qt_with/738217" class="button-steel">Message History</a></li>
	        <li class="button-list-item"><a href="/reservation/cancel?code=5ETBAF" class="button-steel" onclick="if (confirm('Are you sure that you want to cancel the request? Any money transacted will be refunded.')) { var f = document.createElement('form'); f.style.display = 'none'; this.parentNode.appendChild(f); f.method = 'POST'; f.action = this.href;f.submit(); };return false;" target="_blank">Cancel Request</a></li>
	      </ul>

	</li>
	
	<li class="previous_trips_item clearfix">
	    <p class="status"><span class="reservation_accepted rounded_less">Accepted</span></p>
	    <p class="location">
	        <a href="http://www.airbnb.com/rooms/193448">큰개키우는집</a> Seoul
	    </p>
	    <p class="host"><a href="/users/show/738217">Choimyun 김.</a></p>
      ...
      <ul class="button-list">
        <li class="button-list-item"><a href="/messaging/qt_with/738217" class="button-steel">Message History</a></li>
        <li class="button-list-item"><a href="/reservation/print_confirmation?code=5ETBAF" class="button-steel">View Itinerary</a></li>
        <li class="button-list-item"><a href="/reservation/guest_billing_receipt?code=5ETBAF" class="button-steel">View Receipt</a></li>
      </ul>
            ...
            <div class="box">
                <div class="top">&nbsp;</div>
                <div class="middle">
                    <p>You have no upcoming trips. <br /><br /></p>
                    <script>
    function is_not_set_location() { return (!$('location').value || ("Where are you going?"==$('location').value)) }
...
<style>
    ...
    #location_bar { background: url("/images/page1/search_bar_i18n.gif") no-repeat 0 0; height:48px;width:430px; }
    #location_bar #location_container { float:left; width:295px; margin-left:5px; padding-top:5px;padding-left:5px; } 
    #location_bar #location {  vertical-align:middle;width:295px;height:30px;padding:5px 0px 0px 0px;margin:0px;border:none;font-size:1.6667em;font-weight: bold; color: #e0007a;  }
    #location_bar #button { float:right;width:120px;height:48px;margin-left:3px;cursor:pointer; display:inline; text-align:center;}
        *html #location_bar #button{width:110px;}
</style>

<form action="/search" id="search_form" method="post">    <div id="location_bar">
        <div id="location_container">
            <input type="text" id="location" name="location" value="Where are you going?" onclick="clear_location(this);" />
        </div>
        <div class='search_button' id="button" onclick="if (check_inputs()) {$('search_form').submit();}return false;">Search</div>
        <div class="clear"></div>
    </div>

    <input src="http://s0.muscache.com/1300304855/images/page1/pixel.gif" type="image" /><!-- hidden pixel allows form to be submitted when user hits ENTER -->
</form>
	...
	<script type="text/javascript" charset="utf-8">NREUMQ.push(["nrf2","beacon-1.newrelic.com","fc09a36731",2237,"dlwMQktaWAgBEB1aXFhWTUJLVEIBCD1CXlJbQD1DSVZbCQ0MVQ==",0,113])</script></body>
</html>
