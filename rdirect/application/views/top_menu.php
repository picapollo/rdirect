<div id="header" class="clearfix">
			<a id="logo" href="http://www.airbnb.com" title="Airbnb.com Home">
				<img alt="Airbnb - Travel like a human." border="0" height="45" src="http://s2.muscache.com/1309460642/images/logos/109x45.png" width="109">
					...
					<a href="/rooms/new" class="rounded hide_when_printing" id="list-your-space">List your space</a>
          <ul id="utilities">
							<li class="first-child"><a href="https://www.airbnb.com/signup_login">Sign Up</a></li>
             	<li><a href="https://www.airbnb.com/login">Sign In</a></li>
          	...
          	<li style="border-right:1px solid #DDD;"><a href="/info/how_it_works">How it works</a></li>
                ...
                <div id="language_currency_selector_container" class="rounded" style="display:none;">
              			...
              			<li class="instruction">Choose currency...</li>
												...
												<li class="currency option" id="currency_selector_EUR" name="EUR"> € EUR </li>
												<li class="currency option" id="currency_selector_GBP" name="GBP"> £ GBP </li>
												...
												<li class="currency option" id="currency_selector_JPY" name="JPY"> ¥ JPY </li>
