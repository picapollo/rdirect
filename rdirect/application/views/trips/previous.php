...
<!--<![endif]-->
<!--[if lte IE 7]>
<link href="http://s0.muscache.com/1312792888/assets/common.css" media="screen" rel="stylesheet" type="text/css" />
<![endif]-->
    <link href="http://s3.muscache.com/1312750809/stylesheets/dashboard.css" media="screen" rel="stylesheet" type="text/css" />

      <link href="http://s0.muscache.com/1300304856/stylesheets/korean_fonts.css" media="screen" rel="stylesheet" type="text/css" />

		<script src="http://s2.muscache.com/1312798199/assets/common.js" type="text/javascript"></script>
...
<link href="http://s1.muscache.com/1300304856/stylesheets/calendar_date_select/silver.css" media="screen" rel="stylesheet" type="text/css" />
  ...
  <body class=" " >
    ...
    <link href="http://s1.muscache.com/1312750814/stylesheets/referral_rooster.css" media="screen" rel="stylesheet" type="text/css" />
    <script type="text/javascript">
  var ReferralRooster = {
        ...
        <div id="header" class="clearfix">
          ...
          <ul id="utilities">
							<li class="first-child">
								안녕하세요, Hojoon L!&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/home/dashboard">마이 대쉬보드</a>
							</li>
...
<ul id="nav">
	...
	<li ><a href="/rooms">호스팅하기</a></li>
	<li class="active" ><a href="/trips">여행하기</a></li>
    ...
    <ul class="subnav">
    <li><a href="/trips/current">현재의 여행</a></li>
    <li><a href="/trips/upcoming">미래의 여행</a></li>
    <li class="active"><a href="/trips/previous">과거의 여행</a></li>
    <li class="starred"><a href="/search?starred=true">찜 리스트</a></li>
</ul>
                    ...
                    <div class="middle">
                        <ul class="previous_trips">
                            <li class="headings previous_trips_item clearfix">
                                <p class="status">상태</p>
                                <p class="location">객실/위치</p>
                                <p class="host">호스팅하기</p>
                                <p class="dates">날짜</p>
                                <p class="options">옵션</p>
                            </li>
						    
	<li class="previous_trips_item clearfix">
	    <p class="status"><span class="reservation_bad rounded_less">만료되었습니다.</span></p>
	    <p class="location">
	        <a href="http://www.airbnb.com/rooms/162992">22</a> Seoul
	    </p>
	    <p class="host"><a href="/users/show/755884">Choimyun K</a></p>
	    <p class="dates">Jul 5 - 6, 2011</p>
	      
      <ul class="button-list">
        <li class="button-list-item"><a href="/messaging/qt_with/755884" class="button-steel">메세지함</a></li>
      </ul>
	...
	<script type="text/javascript" charset="utf-8">NREUMQ.push(["nrf2","beacon-1.newrelic.com","fc09a36731",2237,"dlwMQktaWAgBEB1aXFhWTUJLVEIBCD1CXlJbQD1GS1BCDQsXQQ==",0,62])</script></body>
</html>
