...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:fb="http://www.facebook.com/2008/fbml">
    ...
    <!--[if (!IE)|(gte IE 8)]><!-->
<link href="http://s0.muscache.com/1312939138/assets/common-datauri.css" media="screen" rel="stylesheet" type="text/css" />
<!--<![endif]-->
<!--[if lte IE 7]>
<link href="http://s0.muscache.com/1312939135/assets/common.css" media="screen" rel="stylesheet" type="text/css" />
<![endif]-->

      <link href="http://s0.muscache.com/1300304856/stylesheets/korean_fonts.css" media="screen" rel="stylesheet" type="text/css" />

		<script src="http://s1.muscache.com/1312954436/assets/common.js" type="text/javascript"></script>
...
<li id="star-indicator"><a href="/search?starred=true" class="notification_icon starred" title="View your starred items">                                <span style="width: 1px; margin-right: -5px;">&nbsp;</span>
	...
	#home_static p { margin-top: 10px; margin-bottom:10px; line-height:18px; }

    #home_static ol { list-style-position:inside; list-style-type:decimal; }
...
<div id="home_static"><div id="content">
	...
	<div class="nav_links"><a href="/home/my_listings">모든 예약하기로 돌아가기</a></div>

    <p>
      다음은 Hojoon Lim 여행객이 <a href="http://www.airbnb.com/rooms/193448">큰개키우는집</a> 주인장에게 한 화, 2011년 08월 09일 (화)부터 시작하는 예약 5ETBAF과 관련이 있습니다.
    </p>


        <p>
          에어비앤비는 <b>주인장의 예약 취소를 매우 심각하게 생각하며 자제 요청 부탁드립니다.</b> 여행객이 언짢아 할 뿐 아니라 에어비앤비와 관련된 사람들과 에어비앤비 서비스 전체의 질을 떨어뜨리기 때문입니다. 그래도 꼭 불가피하게 취소를 하셔야 한다면, 다음에 나오는 사항을 따라주십시오.
        </p>

        <ol>
          <li>
            bdirect@naver.com로 이메일을 보내서 여행객과 연락하세요.
          </li>
          <li>상황을 정중히 설명해 주십시오.</li>
          <li>가능하다면 에어비앤비나 타회사에서 제공하는 다른 숙박을 추천해 주세요.</li>
          <li>밑에 있는 양식을 써서 예약을 취소하세요.</li>
        </ol><br />

        <p>
          취소를 최소화하기 위해 <b>위약금이 존재합니다</b>. 한번 취소했을 때의 위약금은 미미합니다. 하지만 취소를 많이 하게 된다면 회원님의 에어비앤비 활동에 악영향을 미칠 것입니다. 위약금은 다음과 같습니다:
        </p>
        <ol>
          <li>회원님의 위치/순위는 검색 결과 페이지에서 낮아질 겁니다.</li>
          <li>예약이 취소되었다는 내용이 회원님의 계정에 나타날 것입니다.</li>
          <li>취소된 본 예약의 기간 동안 달력은 예약불가로 표시됩니다.</li>

                <li>첫번째 예약취소 건에 대하여는 위약금이 없습니다. 그러나 6개월 기간에 두 번 이상 예약을 취소하시면 두번째 예약취소 건 발생 시 위약금이 발생하게 됩니다. 본 취소 건에 대하여는 위약금이 없습니다.</li>
    ...
    <hr />
    <br />
        <p>본 예약의 체크인이 임박하였으므로 urgent@airbnb.com로 연락주시거나1-855-4AIRBNB로 전화주셔서 취소하시기 바랍니다.</p>
	...
	<script type="text/javascript" charset="utf-8">NREUMQ.push(["nrf2","beacon-1.newrelic.com","fc09a36731",2237,"dlwMQktaWAgBEB1AVkZWEEBYQV0LCk1aXUBBbAFXV1ZRCA==",0,93])</script></body>
</html>
