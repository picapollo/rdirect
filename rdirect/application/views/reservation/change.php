...
<li id="star-indicator" style="display: none;"><a href="/search?starred=true" class="notification_icon starred" title="View your starred items">                                <span style="width: 1px; margin-right: -5px;">&nbsp;</span>
		...
		<style>
	#home_static h1 { margin-bottom: 0px; }
	#home_static div.nav_links { margin-bottom: 25px; }
	
	#home_static h2 { margin-bottom: 0px; }

	#home_static p { margin-top: 0px; margin-bottom:20px; }
    #home_static div.p { margin-top: 0px; margin-bottom:20px; }
	
	#home_static table td { vertical-align:top; }
	#home_static table td.icon { width:190px; text-align:left; }
	#home_static div.section { margin: 0px 25px 25px 0px; padding: 15px;  height:130px; width:250px; background-color:#F7F7F7; }
	#home_static div.section p { height:70px; }

    #home_static ul { list-style-type:disc; list-style-position:inside; }
    #home_static h4 { font-weight:bold; }
</style>


<div id="home_static"><div id="content">

	<h1>Change Reservation 5ETBAF</h1>
	
	<div class="nav_links"><a href="/home/dashboard">Return to Dashboard</a></div>


	<h2>Extend/Shorten Reservation</h2>
	<p>
      You may request a change to the start date or end date of this reservation. Changes are subject to availability and must be approved by both the guest and the host. <br/><br/>
            <a href="/reservation_alterations/new?code=5ETBAF">Request a change</a>
	</p>
	
	
	<h2>Cancel Reservation</h2>
    <p>
        Changes to this reservation are governed by the following standardized policy:
        "<b><a id="cancellation_policy_show_link" href="#" onclick="Element.hide('cancellation_policy_show_link');Element.show('cancellation_policy');Element.show('cancellation_policy_hide_link');return(false);" >Flexible: Full refund 1 day prior to arrival</a><a id="cancellation_policy_hide_link" href="#" onclick="Element.hide('cancellation_policy_hide_link');Element.show('cancellation_policy_show_link');Element.hide('cancellation_policy');return(false);" style="display:none;">Flexible: Full refund 1 day prior to arrival</a></b>."
    </p>

    <div id="cancellation_policy" class="p" style="display:none;">
...
<li>A reservation is not officially canceled until the guest receives a cancellation confirmation e-mail from Airbnb. To get your cancellation e-mail, go to Travel Plans. If the cancellation e-mail is not received, contact Airbnb.</li>
    ...
    <div class="p">
            ...
            There is no penalty for canceling a reservation request. If any charges were made they will be refunded completely.

        <br /><br />

<form action="/reservation/cancel?code=5ETBAF" method="post">
          <div style="margin-bottom:5px;">Reason for canceling: <select id="category" name="category"><option value=""></option>
<option value="Travel Dates Changed">Travel Dates Changed</option>
<option value="Found Better Accommodations">Found Better Accommodations</option>
<option value="Pricing was Wrong">Pricing was Wrong</option>
<option value="Host Canceled Reservation">Host Canceled Reservation</option>
<option value="Host Omitted/Changed Details">Host Omitted/Changed Details</option>
<option value="Uncomfortable with Host">Uncomfortable with Host</option>
<option value="Other">Other</option></select></div>

            <input name="commit" onclick="if (!confirm('Are you sure you want to retract your reservation request?')) return false; return true;" type="submit" value="Cancel Reservation" />
</form>
    </div>
    ...
    <h2>Other Changes</h2>
    <p>
        For other changes, please e-mail <a href="mailto:contact@airbnb.com">contact@airbnb.com</a> with the specific request.
    </p>
	...
	<script type="text/javascript" charset="utf-8">NREUMQ.push(["nrf2","beacon-1.newrelic.com","fc09a36731",2237,"dlwMQktaWAgBEB1AVkZWEEBYQV0LCk1RWlJbVAc=",0,101])</script></body>
</html>
